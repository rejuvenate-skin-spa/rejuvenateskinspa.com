...
const faqSections = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Plasma microneedling uses controlled plasma energy in conjunction with microchannels created by microneedling. The plasma enhances healing, reduces inflammation, and boosts cellular regeneration.",
      },
      {
