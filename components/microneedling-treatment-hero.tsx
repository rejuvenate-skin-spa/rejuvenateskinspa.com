...
export default function MicroneedlingTreatmentHero({
  title = "Advanced",
  subtitle = "Microneedling Treatment",
  description = "Collagen induction therapy that improves skin texture, reduces fine lines, and minimizes pores through controlled micro-injuries that stimulate natural healing.",
  ...
  return (
    <section className="relative h-[500px] overflow-hidden">
      <Image
        ...
        alt="Advanced Microneedling Treatment at Rejuvenate Skin Spa"
        fill
