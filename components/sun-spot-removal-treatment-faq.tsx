    ...
    faqs: [
      {
        ...
        answer:
          "The provider will clean and numb the area before applying the Plexr device to each sun spot individually. The plasma arc sublimates the pigmented tissue, forming small carbon crusts over the treated area. Sessions typically last 15–30 minutes, depending on the number of spots.",
      },
      {
