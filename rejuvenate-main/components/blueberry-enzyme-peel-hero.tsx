...
export default function BlueberryEnzymePeelHero() {
  ...
  return (
    <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-900">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            variant="outline"
            className="border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white px-6 py-2 bg-transparent shadow-lg backdrop-blur-sm"
            onClick={scrollToFAQ}
          >
            Learn More
          </Button>
