      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  ...
                  damaging surrounding healthy skin.
                </p>
                <p>
                  The plasma energy specifically targets the melanin in pigmented lesions, breaking down the excess
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Pigmentation+Treatment"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Plasma energy specifically targets pigmented areas without affecting healthy skin.",
              },
              {
                icon: Shield,
      ...
      <section className="py-16 bg-sage-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pricing based on size, quantity, and complexity of pigmented lesions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                category: "Small Spots",
                size: "Up to 5mm",
                description: "Individual small sun spots or freckles.",
                price: "$100",
                quantity: "Per spot",
              },
              {
                category: "Medium Spots",
                size: "5-10mm",
                description: "Medium-sized age spots or pigmented lesions.",
                price: "$150",
                quantity: "Per spot",
              },
              {
                category: "Large Spots",
                size: "10-20mm",
                description: "Larger pigmented areas requiring more treatment.",
                price: "$250",
                quantity: "Per spot",
              },
              {
                ...
                size: "Various sizes",
                description: "Package pricing for multiple spots in one session.",
                price: "$600",
                quantity: "Up to 10 spots",
              },
            ].map((pricing, index) => (
              <Card
                key={index}
