        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Wart+Removal+Treatment"
                alt="Wart removal plasma treatment"
                width={500}
                height={400}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>
                  The plasma energy precisely targets wart tissue while preserving surrounding healthy skin. This method
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Plasma+Wart+Treatment"
      ...
      <section className="py-16 bg-sage-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pricing based on wart type, size, and location complexity.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                category: "Small Warts",
                size: "Up to 5mm",
                description: "Small common warts on hands or fingers.",
                price: "$150",
                sessions: "1-2 sessions",
              },
              {
                category: "Medium Warts",
                size: "5-10mm",
                description: "Medium-sized warts requiring more treatment.",
                price: "$250",
                sessions: "1-3 sessions",
              },
              {
                category: "Large/Complex",
                size: "Over 10mm",
                description: "Large or plantar warts requiring multiple treatments.",
                price: "$400",
                sessions: "2-4 sessions",
              },
              {
                category: "Multiple Warts",
                size: "Various sizes",
                description: "Package pricing for multiple warts in one area.",
                price: "$500",
