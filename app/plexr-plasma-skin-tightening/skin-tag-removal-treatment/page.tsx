          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg">
                Safe, precise removal of unwanted skin tags using advanced plasma technology. Quick procedure with
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Skin+Tag+Removal"
                alt="Skin tag removal plasma treatment"
                width={500}
                height={400}
