          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-amber-700">
                All moles must be evaluated and cleared by a dermatologist or
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  ...
                  minimizing the risk of scarring. This allows for precise depth
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the advantages of advanced plasma technology for safe
              mole removal and clients seeking a non-invasive, cosmetic
              alternative for the removal of benign moles, skin tags, or similar
              imperfections with limited chances of scaring.
            </p>
          </div>
