          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 max-w-lg">
                Ultra-gentle plasma technology that improves skin texture and tone with microscopic precision. Perfect
                for those seeking skin rejuvenation with zero downtime.
              </p>
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Nano-Ablative+Plasma+Treatment"
                alt="Nano-ablative plasma skin resurfacing treatment"
                width={500}
                height={400}
