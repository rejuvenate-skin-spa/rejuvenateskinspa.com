          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-playfair font-bold text-gray-900 leading-tight">
                Advanced
                <span className="text-sage-600 block">Microneedling Treatment</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-lg">
                Collagen induction therapy that improves skin texture, reduces fine lines, and minimizes pores through
                controlled micro-injuries that stimulate natural healing.
              </p>
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Microneedling+Treatment"
                alt="Microneedling collagen induction therapy"
                width={500}
                height={400}
