          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Red light therapy, also known as photobiomodulation, uses
                specific wavelengths of red and near-infrared light (660-850nm)
                to stimulate cellular processes. This FDA-approved treatment
                penetrates deep into tissues to promote healing, reduce
                inflammation, and boost cellular energy production.
              </p>
              <p className="text-lg text-gray-700 mb-8">
                The therapeutic light wavelengths are absorbed by mitochondria
                in your cells, increasing ATP production and triggering
                beneficial biological processes that promote healing, reduce
                pain, and improve skin health naturally.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the natural healing power of therapeutic light
              wavelengths
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Stimulates collagen production, reduces fine lines, and
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Reduces inflammation and promotes healing for muscle soreness,
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Boosts mitochondrial function and ATP production for enhanced
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Reduces acne-causing bacteria and inflammation while promoting
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Accelerates tissue repair and reduces healing time for cuts,
                  bruises, and post-procedure recovery.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Supports mental wellness by potentially improving mood, energy
      ...
      <section className="py-16 bg-sage-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Red light therapy addresses a wide range of skin and wellness
              concerns
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Natural healing therapy with flexible pricing options
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-sage-600 to-sage-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Experience the natural healing power of red light therapy for better
            skin and wellness
          </p>
