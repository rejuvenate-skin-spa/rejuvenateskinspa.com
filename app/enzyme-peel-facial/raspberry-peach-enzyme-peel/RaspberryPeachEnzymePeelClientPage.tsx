          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-playfair text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Gentle Hydrating Treatment
              </h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Our Raspberry-Peach Enzyme Peel combines the gentle exfoliating properties of raspberry seeds with the
                deep moisturizing benefits of peach extract. This delicate treatment is perfect for all skin types,
                especially those seeking gentle renewal with maximum hydration and comfort.
              </p>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-sage-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Gentle Raspberry Exfoliation</h3>
                    <p className="text-gray-700">Natural raspberry enzymes provide the gentlest form of skin renewal</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-sage-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Peach Hydration</h3>
                    <p className="text-gray-700">Rich peach extract deeply moisturizes and softens skin texture</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-sage-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900">All Skin Types</h3>
                    <p className="text-gray-700">Perfect for sensitive, dry, or mature skin needing gentle care</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <Image
                src="/placeholder.svg?height=500&width=600&text=Raspberry-Peach+Treatment+Benefits"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the gentle, hydrating effects of our Raspberry-Peach Enzyme Peel
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Silky Softness</h3>
                <p className="text-gray-700">
                  Peach extract leaves skin feeling incredibly soft and smooth to the touch.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Deep Hydration</h3>
                <p className="text-gray-700">
                  Natural fruit moisture penetrates deeply for long-lasting skin hydration.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-700">Perfect for sensitive skin types that need nurturing, gentle treatment.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Universal Appeal</h3>
                <p className="text-gray-700">Suitable for all ages and skin types seeking gentle renewal.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Quick Recovery</h3>
                <p className="text-gray-700">Minimal downtime with immediate hydration and comfort.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-700">Pure fruit enzymes and extracts for natural skin enhancement.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Affordable luxury for your skin care needs</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6">Perfect for trying our gentle raspberry-peach treatment</p>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow relative">
              ...
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6">Optimal results with our recommended treatment series</p>
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6">Maximum value for long-term skin health</p>
                <Button className="w-full bg-sage-600 hover:bg-sage-700">Book Series</Button>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-700">We assess your skin type and discuss your hydration goals.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700">Gentle cleansing prepares your skin for the enzyme treatment.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Application</h3>
              <p className="text-gray-700">Raspberry-peach enzyme mask is applied for gentle exfoliation.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Hydration</h3>
              <p className="text-gray-700">Moisturizing treatment seals in hydration and softness.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-sage-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4">Vitamin-rich treatment for sensitive skin and gentle renewal.</p>
                <Button
                  variant="outline"
                  className="w-full border-sage-600 text-sage-600 hover:bg-sage-600 hover:text-white bg-transparent"
                >
      ...
      <section className="py-16 bg-sage-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-sage-100 mb-8 max-w-2xl mx-auto">
            Experience the nurturing benefits of our Raspberry-Peach Enzyme Peel. Book your appointment today.
          </p>
