        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-white text-sage-600 px-8 py-3 rounded-md font-semibold hover:bg-gray-50 transition-colors duration-200"
            >
              Call (480) 225-9549
            </a>
            <a
              href="/about-us/contact-us"
              className="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-sage-600 transition-colors duration-200"
            >
              Contact Us
            </a>
          </div>
