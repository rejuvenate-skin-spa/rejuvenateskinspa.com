  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  BioRePeel 50 TCA is specifically formulated for body treatments, featuring a higher concentration of
                  50% Trichloroacetic Acid combined with amino acids and vitamins. This powerful formula is designed to
                  address more stubborn skin concerns on the body.
                </p>
                <p>
                  The thicker skin on the body can handle this higher concentration, making it ideal for treating areas
                  like the back, chest, arms, and legs where traditional facial treatments may not be strong enough to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              BioRePeel 50 TCA can effectively treat various body areas for comprehensive skin improvement.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                area: "Back & Shoulders",
                description: "Treat back acne, scarring, and rough texture for smoother skin.",
                price: "$300",
                duration: "60 minutes",
              },
              {
                area: "Chest & Décolletage",
                description: "Address sun damage, age spots, and fine lines in delicate areas.",
                price: "$250",
                duration: "45 minutes",
              },
              {
                area: "Arms & Hands",
                description: "Improve skin texture and reduce age spots on arms and hands.",
                price: "$200",
                duration: "45 minutes",
              },
              {
                area: "Legs",
                description: "Smooth rough skin and improve overall texture on legs.",
                price: "$350",
                duration: "75 minutes",
              },
            ].map((area, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience dramatic improvements in body skin texture and appearance.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Effectively addresses back acne, chest acne, and body breakouts.",
              },
              {
                icon: Star,
                title: "Reduces Scarring",
                description: "Minimizes the appearance of acne scars and other body imperfections.",
              },
              {
                icon: Zap,
                title: "Improves Texture",
                description: "Smooths rough, bumpy skin for a more refined appearance.",
              },
              {
                icon: Shield,
                title: "Fades Hyperpigmentation",
                description: "Reduces dark spots, age spots, and uneven skin tone.",
              },
              {
                icon: Award,
                title: "Professional Strength",
                description: "Higher concentration formula for more dramatic results.",
              },
              {
                icon: Clock,
                title: "Long-Lasting Results",
                description: "Provides lasting improvement with proper maintenance.",
              },
            ].map((benefit, index) => (
      ...
      <section className="py-16 bg-sage-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Your BioRePeel 50 TCA body treatment experience.</p>
          </div>
            ...
            {[
              {
                step: "01",
                title: "Assessment",
                description: "Thorough evaluation of treatment areas and skin concerns.",
              },
              {
                step: "02",
                title: "Preparation",
              ...
              },
              {
                step: "03",
                title: "Application",
                description: "Careful application of BioRePeel 50 formula to target areas.",
              },
              {
                step: "04",
                title: "Monitoring",
                description: "Close monitoring during treatment for optimal results.",
              },
              {
                step: "05",
                title: "Aftercare",
                description: "Post-treatment care and detailed recovery instructions.",
              },
            ].map((item, index) => (
              <div key={index} className="text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-gray-900">Ideal for treating:</h3>
      ...
      <section className="py-16 bg-sage-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-playfair font-bold text-gray-900 mb-4">Recovery & Aftercare</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Days 1-3: Initial Healing</h4>
                    <p className="text-gray-600">
                      Mild redness and sensitivity. Keep treated areas clean and moisturized.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Days 3-7: Peeling Phase</h4>
                    <p className="text-gray-600">Light peeling may occur. Avoid picking and use gentle moisturizers.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-sage-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-4 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Days 7-14: Renewal</h4>
                    <p className="text-gray-600">New skin emerges smoother and more refined. Results become visible.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-sage-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-playfair font-bold mb-4">Transform Your Body Skin Today</h2>
