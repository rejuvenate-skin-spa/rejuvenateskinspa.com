          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-playfair font-bold text-gray-900 leading-tight">
                BioRePeel 35
                <span className="text-sage-600 block">TCA Facial Peel</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-lg">
                Advanced facial rejuvenation with 35% TCA concentration. Perfect for improving skin texture, reducing
                fine lines, and achieving a radiant complexion with minimal downtime.
              </p>
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=BioRePeel+35+Facial+Results"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=35+TCA+Formula"
                alt="BioRePeel 35 TCA formula"
                width={500}
                height={400}
                className="rounded-lg shadow-xl"
              />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image
                src="/placeholder.svg?height=400&width=500&text=Ideal+Candidate+Results"
