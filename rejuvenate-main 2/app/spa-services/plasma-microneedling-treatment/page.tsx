...
export const metadata: Metadata = {
  title: "Plasma Pen Microneedling | Rejuvenate Skin Spa Queen Creek",
  description:
  ...
  keywords:
    "plasma microneedling, collagen induction, skin tightening, Queen Creek spa, Rejuvenate Skin Spa",
}
